...
from communityai_anchor import worker_loading as _private
...
class GenerationRecoveryBinding:
    ...
    def from_json(cls, value):
        ...
        linux_cgroup = None
        if version == 2:
            from communityai_anchor.linux_cgroup_recovery import LinuxCgroupIdentity
...
def _contract(owner, reservation_id, kind, linux_cgroup=None):
    if linux_cgroup is not None:
        from communityai_anchor.linux_cgroup_recovery import LinuxCgroupIdentity, generation_name
