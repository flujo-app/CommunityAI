...
class SequenceManagerConfig(ClientConfig):
    def __init__(self, *args, **kwargs):
        warnings.warn(
            "drift.client.routing.SequenceManagerConfig has been moved to drift.ClientConfig. "
            "This alias will be removed in DRIFT-LLM 2.2.0+",
            DeprecationWarning,
            stacklevel=2,
        )
...
class RemoteSequenceManager:
    ...
    def get_request_metadata(
        ...
        :param args_structure: the structure of flattened tensors from pack_args_kwargs in drift.utils.packaging
