...
class TextGenerationEngine:
    ...
    async def stream(self, payload, remote_peer):
        ...
        task = asyncio.create_task(asyncio.to_thread(self._generate, payload, key, cancel, out))
    ...
    def _generate(self, payload, key, cancel, out):
        ...
        try:
            ...
            if payload["chat"]:
                ...
                options = {} if body.enable_thinking is None else {"enable_thinking": body.enable_thinking}
