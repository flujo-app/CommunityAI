...
| 14 | Pass contribution-control hardware checks | IN PROGRESS | [PR #11](https://github.com/flujo-app/CommunityAI/pull/11) integrated [commit `732b8fa`](https://github.com/flujo-app/CommunityAI/commit/732b8fae6deb6eb3a1ea502c224c8772f8715e3c) after [style](https://github.com/flujo-app/CommunityAI/actions/runs/32957678733), [tests](https://github.com/flujo-app/CommunityAI/actions/runs/32957678935), and [Windows/Linux production packaging](https://github.com/flujo-app/CommunityAI/actions/runs/32957678732) passed, carrying the bounded node-authoritative status contract through the packaged Sharing page; the current repository slice adds authenticated revision-bound editing for all ten policy fields, complete validation, paused-worker enforcement, a shared writer lock, and conflict-restoring atomic Windows/Linux persistence; 100 focused tests, the 472-pass/8-skip offline CI selection, Black/isort, and source/UI self-tests pass | Validate enforcement, suspension, pause timing, persistence across packaged restart, and unsupported telemetry on real packaged Windows/Linux hardware; the repository evidence does not pass this hardware gate |
