...
USD 100. The new `gate9-20260829-b` reservation consumes USD 28 and leaves **USD 72** in
the current authorization epoch pending eventual billing reconciliation. Fly credit is not
counted as extra authorization.
