...
The schema-v2 noncash simulator now has listing, transfer, lot-specific service
use, risk-held proceeds and reversal states. It uses a one-to-one synthetic
price/credit rate; it is not a payment or payout integration. Resale remains
disabled in the product API and UI pending provider approval, actual currencies,
seller eligibility, funded liabilities and the other B6c gates.
